        ...
        <div
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group mr-2">
                    <a href="{{route('backend_commande_index')}}" class="btn btn-sm btn-outline-secondary">Lister les
                        commandes</a>
                </div>
        ...
        <div class="table-responsive">
            <div class="jumbotron">
                ...
                <p>{{$commande->adresse->adresse}}<br>
                    ...
                    {{$commande->adresse->ville}} - {{$commande->adresse->pays}}</p>
            ...
            <table class="table table-bordered">
                ...
                @foreach($commande->produits as $produit)
                    <tr>
                        <td>{{++$loop->index}}</td>
                        {{--numero ligne avec+++$lopp--}}
                        <td>
                            <strong>{{$produit ->nom}}
                                @if($produit->pivot->taille) -
                                Taille {{$produit->pivot->taille->nom}}
{{--                                pivot = l association et taille la fonction...--}}
                                @endif</strong> <br>
                        </td>
