...
@section('content')
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <form action="{{route('backend_produit_store_size',['id'=>$produit->id])}}" method="post">
            ...
            <div class="row">
                <div class="col-12">
                    <label for="type_id">Séléectionnez un type de taille</label>
        ...
        <table class="table table-striped">
            ...
            @foreach($produit->tailles as $taille)
                <tr>
                    ...
                    <td>
                        <a href="#" class="btn btn-outline-danger btn-sm remove_size"
                           data-id_produit="{{$produit->id}}" data-id_taille="{{$taille->id}}">Retirer la taille</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
