...
@section('content')
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <form action="{{route('backend_produit_update',['id'=>$produit->id])}}" method="post"
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="prix_ht">Quantite</label>
                    <input type="text" class="form-control" id="prix_ht" name="quantite"
            ...
            <div class="form-row">
                ...
                <div class="col-md-4">
                    <img width="100" class="img rounded-circle" style="border: 1px solid black"
                    ...
                    <select class="form-control form-control-lg" id="category_id" name="category_id">
                        @foreach($categories as $categorie)
                            @if($produit->categorie && $produit->categorie->id == $categorie->id)
                                <option selected
                                        value="{{$categorie->id }}">{{$categorie->nom }}</option>{{--préselection--}}
                            @else
