                    ...
                    <form action="{{route('commande_store_adresse')}}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-4">
                                ...
                                <input  autocomplete="off" type="text" class="form-control" id="prenom" name="prenom"
                                       value="{{$adresse->prenom ?? old('prenom')}}">
                            </div>
                            <div class="col-md-3 mb-4">
                                <label for="nom">Votre nom <span class="text-danger">*</span></label>
                                <input autocomplete="off" type="text" class="form-control" id="nom" name="nom"
                                       value="{{$adresse->nom ?? old('nom')}}">
                            </div>
                            <div class="col-md-3 mb-4">
                                <label for="telephone">Votre téléphone <span class="text-danger">*</span></label>
                                <input autocomplete="off" type="text" class="form-control" id="telephone" name="telephone"
                        ...
                        <div class="mb-3">
                            ...
                            <input autocomplete="off" type="text" class="form-control" id="adresse" name="adresse"
                                   value="{{$adresse->nom ?? old('nom')}}">
                        </div>

                        <div class="mb-3">
                            <label for="adresse2">Complément d'adresse<span class="text-muted">(Optional)</span></label>
                            <input autocomplete="off" type="text" class="form-control" id="adresse2" name="adresse2"
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-4">
                                ...
                                <input autocomplete="off" type="text" class="form-control" id="ville" name="ville"
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <select class="custom-select d-block w-100" id="pays" name="pays" required>
                                    {{-- $code => $p code pays et pays--}}
                                    @foreach($pays as $code => $p)
                                        {{-- preselection le pays deja enregistrer--}}
                                        <option
