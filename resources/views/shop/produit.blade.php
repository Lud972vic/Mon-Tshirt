                        ...
                        <p>
                            @if(count($p->tailles) == 0)
                                @if($p->quantite >0 )
                                    ...
                                    <input type="number" min="1" max="{{$p->quantite}}" id="qte" name="qte"
                                           autocomplete="off" value="1" class="form-control">
                                    <button class="btn btn-cart my-2 btn-block"><i class="fas fa-shopping-cart"></i>
                                        Ajouter au Panier
                                    </button>
                                @else
                                    <button disabled class="btn btn-cart my-2 btn-block"><i
                                            class="fas fa-shopping-cart"></i> En
                                        rupture de stock !
                                    </button>
                                @endif
                            @endif
